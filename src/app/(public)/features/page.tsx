    ...
    <main>
      ...
      <section className="bg-secondary/12">
        <div className="section-wrapper flex flex-col items-center">
          ...
          <p className="text-center max-w-2/3 mx-auto mb-4">Les fonctionnalités présentes posent les bases, mais Calitrack en est qu&apos;à c&apos;est début. Si jamais tu as des propositions à me faire n&apos;hésite pas à me les partager&nbsp;!</p>
