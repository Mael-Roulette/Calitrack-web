  ...
  return (
    <main>
      <section className="section-wrapper">
        <h1 className="title-hero font-calsans mb-4">À propos de <span className="text-secondary">Calitrack</span></h1>
        <p className="mb-8">Calitrack est une application pensée pour tous ceux qui veulent progresser en calisthenics, du débutant au pratiquant confirmé. Simple, claire et motivante, elle t&apos;accompagne dans tes entraînements et te permet de suivre tes progrès pas à pas.</p>

        {/* Explication du projet */ }
        <div className="mb-12 grid grid-cols-1 lg:grid-cols-[5fr_4fr] gap-x-10 gap-y-6">
          <div>
        ...
        <div className="mb-12 grid grid-cols-1 lg:grid-cols-[4fr_5fr] gap-x-10 gap-y-6">
          <div className='h-64 lg:h-full w-full relative rounded-lg overflow-hidden '>
            <Image
              src={ '/images/mobile.jpg' }
              alt=''
        ...
        <div className="mb-8 grid grid-cols-1 lg:grid-cols-[5fr_4fr] gap-x-10 gap-y-6">
          <div>
            <h2 className="title-section font-calsans mb-2">Qu&apos;est ce que le <span className="text-secondary">futur</span> nous réserve ?</h2>
