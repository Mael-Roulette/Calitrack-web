    ...
    <main>
      ...
      <section className="bg-secondary/12">
        <div className="section-wrapper flex flex-col items-center">
          ...
          <p className="text-center lg:max-w-4/5 mx-auto mb-4">Un problème, une idée, une suggestion ? Peu importe, je lis tous les messages, alors n&apos;hésite pas à m&apos;écrire ! Avant ça, tu peux aussi jeter un œil à notre FAQ, elle contient peut-être déjà la réponse que tu cherches.</p>
